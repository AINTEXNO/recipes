...
WHERE kitchens.alias = ?' . $querySort, array($alias));

$kitchens = new Database('kitchens');
$kitchen = $kitchens->select('WHERE alias = ?', array($alias));
$kitchen = $kitchen->fetch(PDO::FETCH_ASSOC);
?>
...
<section class="navigation">
    ...
    <a href="#" class="navigation__link inactive-link"><?= $kitchen['name'] ?> кухня</a>
</section>
<div class="top-line">
    <h2 class="top-line__title">Кухни &middot; <?= $kitchen['name'] ?> кухня</h2>
</div>
...
<section class="wrap-section category-view">
